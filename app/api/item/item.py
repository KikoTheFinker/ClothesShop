...
async def get_filtered_items_route(
    ...
    wardrobe_id: Optional[int] = Query(None, description="Filter by wardrobe ID"),
...
@router.post("/wardrobe/items/add-item")
...
@router.delete("/wardrobe/items/remove-item")
...
@router.put("/wardrobe/items/update-item")
